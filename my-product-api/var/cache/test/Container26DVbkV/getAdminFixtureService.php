...
// Returns the private 'App\DataFixtures\AdminFixture' shared autowired service.
...
return $this->privates['App\\DataFixtures\\AdminFixture'] = new \App\DataFixtures\AdminFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
