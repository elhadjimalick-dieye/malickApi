...
include_once $this->targetDirs[3].'/src/DataFixtures/AdminFixture.php';
include_once $this->targetDirs[3].'/src/DataFixtures/ProfilFixture.php';
include_once $this->targetDirs[3].'/src/DataFixtures/TarifFixture.php';

$a = new \Doctrine\Bundle\FixturesBundle\Loader\SymfonyFixturesLoader($this);
$a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdminFixture(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ProfilFixture(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\TarifFixture(), 'groups' => []]]);
