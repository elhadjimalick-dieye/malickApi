...
// Returns the private 'App\Repository\EnvoiRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EnvoiRepository.php';

return $this->privates['App\\Repository\\EnvoiRepository'] = new \App\Repository\EnvoiRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
