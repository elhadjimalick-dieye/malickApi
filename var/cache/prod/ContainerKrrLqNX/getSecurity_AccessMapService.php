...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/depot'), [0 => 'ROLE_CAISSIER_SYSTEME'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/partenaire'), [0 => 'ROLE_ADMIN_SYSTEME'], NULL);
